...
public class AppManager extends AbstractNodeMain {
    ...
    public void setListService(ServiceResponseListener<GetAppListResponse> listServiceResponseListener) {
    ...
    public void startApp() {
        ...
        try {
            ...
            startAppClient = connectedNode.newServiceClient(startTopic, StartApp._TYPE);
    ...
    public void stopApp() {
        ...
        try {
            ...
            stopAppClient = connectedNode.newServiceClient(stopTopic, StopApp._TYPE);
        } catch (ServiceNotFoundException e) {
    ...
    public void listApps() {
        ...
        try {
            ...
            listAppsClient = connectedNode.newServiceClient(listService, GetAppList._TYPE);
        } catch (ServiceNotFoundException e) {
